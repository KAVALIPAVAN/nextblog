...
const Sidebar = () => {
  return( <div className="flex flex-col bg-slate-100">
    <div className="px-2 sm:pl-14 py-3 border border-black">
        <Image src={assets.logo} alt="000" width={120} />
    </div>
    <div className="w-28 sm:w-80 h-[100vh] relative py-12 border border-black">
        <div className="w-[50%] sm:w-[80%] absolute right-0">
          ...
          <Image src={assets.add_icon} alt="000" width={28} />
          <p>Add blogs</p>
          </Link>
          ...
          <Image src={assets.blog_icon} alt="000" width={28} />
          <p>Blog lists</p>
          </Link>
          ...
          <Image src={assets.email_icon} alt="000" width={28} />
          <p>Subscriptions</p>
          </Link>
        </div>
